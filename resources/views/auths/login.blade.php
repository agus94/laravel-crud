...
<head>
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('admin/assets/apple-icon.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('admin/assets/favicon.png')}}">
</head>
				...
				<div class="auth-box ">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Data Pengelolaan Data Siswa</h1>
							<p>by AgoesTech</p>
						</div>
					</div>
